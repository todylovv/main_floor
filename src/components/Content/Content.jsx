            ...
            <div className="container mx-auto xl:px-32">
              <div className="flex grid items-center gap-12 lg:grid-cols-2">
                <div className="mt-12 lg:mt-0">
                  ...
                  <a
                    className="mb-2 text-shadow-sm inline-block rounded bg-neutral-50 px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-neutral-800 transition duration-150 ease-in-out focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-md shadow-md hover:shadow-sm focus:shadow-sm active:shadow-sm md:mr-2 md:mb-0"
                    data-te-ripple-init
                  ...
                  <a
                    className="inline-block text-shadow-sm rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-neutral-200 focus:text-neutral-200 focus:outline-none focus:ring-0 active:text-neutral-300 hover:shadow-md focus:shadow-md active:shadow-md"
                    data-te-ripple-init
                    data-te-ripple-color="light"
                    href="#!"
                    role="button"
